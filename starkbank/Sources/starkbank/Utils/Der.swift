...
class Der {
    ...
    static let hexAt = 0x00
    static let hexB = 0x02
    static let hexC = 0x03
    static let hexD = 0x04
    static let hexF = 0x06
    static let hex0 = 0x30
...
//    private let bytesHexF = Base64.encode(string: hexF)
    ...
    func encodedSequence(encodedPieces: [NSData]) -> NSData {
        ...
        joinedData.append(Data([UInt8(Der.hex0)]))
...
//
        ...
        result.append(Data([UInt8(Der.hexF)]))
    ...
    func encodeBitstring(t: String) -> NSData {
        let combinedData = NSMutableData()
        combinedData.append( Data([UInt8(Der.hexC)]))
